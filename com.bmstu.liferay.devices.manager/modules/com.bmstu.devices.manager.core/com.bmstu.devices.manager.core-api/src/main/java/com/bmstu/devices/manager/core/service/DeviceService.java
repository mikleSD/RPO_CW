...
@OSGiBeanProperties(property =  {
	"json.web.service.context.name=dm", "json.web.service.context.path=Device"}, service = DeviceService.class)
@ProviderType
...
public interface DeviceService extends BaseService {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link DeviceServiceUtil} to access the device remote service. Add custom service methods to {@link com.bmstu.devices.manager.core.service.impl.DeviceServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
